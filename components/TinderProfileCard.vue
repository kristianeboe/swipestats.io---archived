<template>
  <div class="max-w-xs md:max-w-md rounded overflow-hidden shadow-lg bg-white hover:shadow-xl">
    ...
    <div class="px-6 py-4">
      ...
      <h2 class="text-xl font-bold" style="overflow-wrap: break-word;">{{ userId }}</h2>
