function dataNormalizer(timeSeriesObject) {
...
function timeSeriesNormalizer(timeSeriesObject) {
...
function aggregateByYear(timeSeriesObject) {
...
function aggregateByMonth(timeSeriesObject) {
